...
public class ECMController {
	...
	public ExpenseDetails getByCode(@PathVariable String expenseCode) throws ECMException {
	...
	public ExpenseDetails DeleteByCode(@PathVariable String expenseCode) throws ECMException {
	...
	public ExpenseDetails modify(@PathVariable String expenseCode,@RequestBody ExpenseDetails expdetails) throws ECMException  {
